...
void ealtan3_vkaspr2(){
  printf("Vira Kasprova vkaspr2\n");
  printf("Enkh-Amgalan Altanshagai ealtan3\n");
  printf("Something we learned about GIT: On replit we can clone a repository either form the command line or from Version Control");
}
